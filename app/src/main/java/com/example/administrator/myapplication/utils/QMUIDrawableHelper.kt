...
object QMUIDrawableHelper {
    private val TAG = QMUIDrawableHelper::class.java!!.getSimpleName()
    ...
    fun createBitmapFromView(view: View, leftCrop: Int, topCrop: Int, rightCrop: Int, bottomCrop: Int): Bitmap? {
        val originBitmap = QMUIDrawableHelper.createBitmapFromView(view) ?: return null
        val cutBitmap = createBitmapSafely(view.width - rightCrop - leftCrop, view.height - topCrop - bottomCrop, Bitmap.Config.ARGB_8888, 1) ?: return null
    ...
    fun getVectorDrawable(context: Context, @DrawableRes resVector: Int): Drawable? {
        try {
            ...
            Log.d(TAG, "Error in getVectorDrawable. resVector=" + resVector + ", resName=" + context.resources.getResourceName(resVector) + e.message)
            return null
        }
