 ...
 * @date 2016-03-25
 */
class QMUIWindowInsetLayout @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0) : FrameLayout(context, attrs, defStyleAttr), IWindowInsetLayout {
    private val mQMUIWindowInsetHelper: QMUIWindowInsetHelper

    init {
        mQMUIWindowInsetHelper = QMUIWindowInsetHelper(this, this)
    }
